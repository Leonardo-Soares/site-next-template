...
export function MenuHamburguer() {
  ...
  return (
    <div
      className={`fixed top-0 z-[999999] flex h-full w-[90%] items-center justify-center bg-white/80 bg-[url(/img/background.png)] bg-cover bg-fixed bg-center shadow-2xl backdrop-blur-md md:hidden ${showMenuHamburguer ? 'right-0' : '-right-[700px]'} overflow-y-auto transition-all`}
    >
      <div className="relative h-full w-full py-20">
        ...
        <div className="flex justify-center px-10 py-4">
          <img src="/img/logo.png" alt="leonardo" />
        </div>
        {/* 
        <div className="py-20">
          {navLinks.map((link) => {
